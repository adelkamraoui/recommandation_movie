...
def get_users():
    users = {}
    with open('/home/adel/Desktop/recomreda/recommandation_movie-master/kn/tables/newuser.csv') as f:
...
def get_app():
    ...
    def register():
        with open('/home/adel/Desktop/recomreda/recommandation_movie-master/kn/tables/newuser.csv', 'r') as f:
            reader = csv.reader(f)
            headers = next(reader)
        ...
        if request.method == 'POST':
            ...
            with open('/home/adel/Desktop/recomreda/recommandation_movie-master/kn/tables/newuser.csv', 'a', newline='') as f:
                writer = csv.writer(f)
    ...
    def ajoutfilm():
        ...
        if request.method == 'POST':
            ...
            CSV_FILE = '/home/adel/Desktop/recomreda/recommandation_movie-master/kn/tables/movies.csv'
